...
import * as fromIndicesComplete from './indice.complete';
/**
 * As mentioned, we treat each reducer like a table in a database. This means
 * our top level state interface is just a map of keys to inner state types.
 */
export interface State {
    indices: fromIndices.INDICE_STATE;
    indicesComplete: fromIndicesComplete.INDICE_ADD_COMPELTE_STATE;
}
...
export const getIndiceCompleteEntities = createSelector(getIndicesState, fromIndicesComplete.getCompleteEntities);